...
# aqui iremos criar um dicionario onde cada chave é o nome da loja
# e os valores são as vendas de cada loja respectivamente
dicionario_lojas = {}
...
# aqui iremos definir o dia indicador, que é data máxima da tabela
...
# aqui iremos criar as pastas com o nome de cada loja
# e armazenar as planilhas com as vendas respectivas de cada loja
...
for loja in dicionario_lojas:
    ...
    # calculando os indicadores e por fim enviando aos gerentes de cada loja
for loja in dicionario_lojas:
...
# criando os rankings, e arquivando na pasta de backup
...
# enviar o e-mail para a diretoria e anexar os arquivos de ranking
outlook = win32.Dispatch('outlook.application')
...
mail.Attachments.Add(str(attachment))
attachment = pathlib.Path.cwd() / caminho_backup / \
    f'{dia_indicador.month}_{dia_indicador.day}_Ranking Diário.xlsx'
mail.Attachments.Add(str(attachment))
